...
import {addToCart, removeFromCartAndSync, syncCartWithBackend} from "../../app/redux/slices/cartSlice";
...
function CartGoods({itemId}) {
    ...
    return (
        ...
        <svg className={`cart__icon-heart ${isCartIconActive ? 'active' : ''}`} onClick={toggleCartIcon} width="24"
             height="24" viewBox="0 0 24 24" fill="none"
             xmlns="http://www.w3.org/2000/svg">
            <path className="cart__icon-heart--color"
