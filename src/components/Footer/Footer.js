        ...
        <footer className="footer">
            <div className="footer-container">
                <div className="footer-container__item">
                    <Link to="/"><img src={logo_main} alt="Sweet shop" className="footer-container__logo--long"></img>
                        <img src={logo_short} alt="Sweet shop" className="footer-container__logo--short"></img>
                    </Link>
                </div>
                <div className="footer-container__item">
                ...
                <div className="footer-container__item footer-container__item-flex">
                    <div className="footer-container__item">
                        ...
                        <ul className="footer-container__socials">
                            <li className="footer-container__socials-item">
                                <a target="_blank" href="https://facebook.com" className="footer-container__list-item--link">
                            ...
                            <li className="footer-container__socials-item">
                                <a target="_blank" href="https://instagram.com" className="footer-container__list-item--link">
                                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li className="footer-container__socials-item">
                                <a target="_blank" href="https://linkedin.com" className="footer-container__list-item--link">
                                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <path fillRule="evenodd" clipRule="evenodd"
                    ...
                    <div className="footer-container__item">
                        <h5 className="footer-container__title footer-container__title-location">Location:</h5>
                        <ul className="footer-container__list">
