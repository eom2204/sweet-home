        ...
        <footer className="footer">
            <WrapperSection>
                <div className="footer-container">
                    <div>
                        <Link to="/"><img src={logo_main} alt="Sweet shop"
                                          className="footer-container__logo--long"></img>
                    ...
                    <div className="footer-container__item">
                        ...
                        <div className="footer-container__item-flex">
                            <div>
                                ...
                                <ul className="footer-container__socials">
                                    <li className="footer-container__socials-item">
                                        <a target="_blank" href="https://facebook.com"
                                           className="footer-container__list-item--link">
            ...
            <div className="footer__copyright">
                <p className="footer__copyright--text">Sweet Home &copy; 2025 <span className="footer__copyright--text-span">All rights reserved</span></p>
            </div>
        </footer>
    )
}
