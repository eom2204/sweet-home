...
function Login() {
    ...
    return (
        <Box sx={{display: 'flex', justifyContent: 'space-between', flexDirection: {xs: 'column', sm: 'row', md: 'row'}, gap: {xs: '16px', sm: '16px', md: '0'}, marginTop: "168px"}}>
            <Box sx={{
                width: {xs: '100%', sm: '100%', md: '50%'},
                display: 'flex',
                flexDirection: 'column',
                alignItems: 'center',
                borderRight: {xs: 'none', sm: 'none', md: '1px solid black'},
            }}>
